          ...
          <div className="card mb-xl-0">
            ...
            <div className="card-body">
              <div className="row">
                ...
                <div className="col-sm-12 col-md-12">
                  <div className="form-group">
                    <label className="form-label text-dark">Enter Name</label>
                    <input
                      type="text"
                ...
                <div className="col-sm-6 col-md-6">
                  <div className="form-group">
                    <label className="form-label">
                      Item Dimensions<span className="text-danger">*</span>
                    </label>
                    <input
                      type="email"
                      className="form-control"
                        ...
                        <div className="custom-controls-stacked d-flex">
                          <label className="custom-control custom-radio mr-4">
                            <input
                              ...
                              defaultChecked
                            />
                            <span className="custom-control-label">Light</span>
                          </label>
                          <label className="custom-control custom-radio">
                            ...
                            />
                            <span className="custom-control-label">Dark</span>
                          </label>
                        </div>
                      </div>
                    </div>
                ...
                <div className="col-md-12">
                  <div className="form-group mb-0">
                    <div className="row">
                      <div className="col-md-3">
                        <label className="form-label">Responsive Layout:</label>
                      </div>
                      <div className="col-md-9">
